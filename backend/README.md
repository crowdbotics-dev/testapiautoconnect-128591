...
## Project Structure
    ...
    ├── testapiautoconnect_128591  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_128591`
...
2. Clone this repo and `cd testapiautoconnect_128591`
